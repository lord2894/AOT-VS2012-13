...
int main(int argc, char **argv)
{
	...
	try
	{
		std::ifstream suff("C:\\RML\\Dicts\\SrcBinDict\\troiki_pref");
		assert(suff.is_open());
		fprintf (stderr,"Opening outfile %s\n", "C:\\RML\\Dicts\\BinDict\\deriv_pref.bin");
		std::ofstream suff_out("C:\\RML\\Dicts\\BinDict\\deriv_pref.bin", std::ios::binary);
