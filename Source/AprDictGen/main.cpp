...
int main(int argc, char ** argv)
{
	try
	{
		...
		bool Bug = false;
		std::ifstream in("C:\\RML\\Dicts\\SrcBinDict\\dict2809.txt");
		std::ofstream out;
		out.open("C:\\RML\\Dicts\\BinDict\\dict.bin", std::ios::binary);
		//if (!Bug)
		...
		FILE * fp = fopen("C:\\RML\\Dicts\\SrcBinDict\\dict2809.txt", "r");
		if (!fp)
		{
